...
// 生成defs/repeat.h
void repeat_gen(const std::string& path, int alias_overload);

// 生成 defs/for_each.h
void for_each_gen(const std::string& path, int alias_overload);

// 生成 defs/for.h
void for_gen(const std::string& path, int alias_overload);

// 生成 defs/while.h
void while_gen(const std::string& path, int alias_overload);

// 生成 defs/for_recursive.h
void for_recursive_gen(const std::string& path, int alias_overload, int max_level);

// 生成 defs/while_recursive.h
void while_recursive_gen(const std::string& path, int alias_overload, int max_level);

// 生成defs/call_exp.h
void call_exp_gen(const std::string& path, int alias_overload);
}
