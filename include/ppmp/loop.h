 ...
 */
#define __for_each__(expand_id) __cat__(3, __for_each_, expand_id, _intl__)
 ...
 */
#define __for__(expand_id) __cat__(3, __for_, expand_id, _intl__)
 ...
 */
#define __while__(expand_id) __cat__(3, __while_, expand_id, _intl__)
