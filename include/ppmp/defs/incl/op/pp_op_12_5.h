...
#undef __pp_op_12_5__
#define __pp_op_12_5__() 0
#else
#undef __pp_op_12_5__
...
#undef __pp_op_12_5__
#define __pp_op_12_5__() 1
#elif ((__pp_expr__()) / 100000) % 10 == 2
#undef __pp_op_12_5__
#define __pp_op_12_5__() 2
#elif ((__pp_expr__()) / 100000) % 10 == 3
#undef __pp_op_12_5__
#define __pp_op_12_5__() 3
#elif ((__pp_expr__()) / 100000) % 10 == 4
#undef __pp_op_12_5__
#define __pp_op_12_5__() 4
#elif ((__pp_expr__()) / 100000) % 10 == 5
#undef __pp_op_12_5__
#define __pp_op_12_5__() 5
#elif ((__pp_expr__()) / 100000) % 10 == 6
#undef __pp_op_12_5__
#define __pp_op_12_5__() 6
#elif ((__pp_expr__()) / 100000) % 10 == 7
#undef __pp_op_12_5__
#define __pp_op_12_5__() 7
#elif ((__pp_expr__()) / 100000) % 10 == 8
#undef __pp_op_12_5__
#define __pp_op_12_5__() 8
#elif ((__pp_expr__()) / 100000) % 10 == 9
#undef __pp_op_12_5__
#define __pp_op_12_5__() 9
#endif

#else

#error "store digit 5 in 'pp_op' 12 failed. expr '__pp_expr__()' not defined"
