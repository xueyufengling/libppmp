#if defined(__pp_op_10__) && defined(__pp_op_14__)
...
#elif (__pp_op_10__()) == (__pp_op_14__())
...
#error "cmp 'pp_op' 10 and 14 failed. '__pp_op_10__()' or '__pp_op_14__()' not defined"
