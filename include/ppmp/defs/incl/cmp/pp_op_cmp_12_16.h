#if defined(__pp_op_12__) && defined(__pp_op_16__)
...
#elif (__pp_op_12__()) == (__pp_op_16__())
...
#error "cmp op 12 and op 16 failed. '__pp_op_12__' or '__pp_op_16__' not defined"
