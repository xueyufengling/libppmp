#if defined(__pp_op_15__) && defined(__pp_op_13__)
...
#elif (__pp_op_15__()) == (__pp_op_13__())
...
#error "cmp 'pp_op' 15 and 13 failed. '__pp_op_15__()' or '__pp_op_13__()' not defined"
