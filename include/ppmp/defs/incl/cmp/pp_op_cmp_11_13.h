#if defined(__pp_op_11__) && defined(__pp_op_13__)
...
#elif (__pp_op_11__()) == (__pp_op_13__())
...
#error "cmp 'pp_op' 11 and 13 failed. '__pp_op_11__()' or '__pp_op_13__()' not defined"
