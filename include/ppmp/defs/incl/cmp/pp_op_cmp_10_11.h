#if defined(__pp_op_10__) && defined(__pp_op_11__)
...
#elif (__pp_op_10__()) == (__pp_op_11__())
...
#error "cmp 'pp_op' 10 and 11 failed. '__pp_op_10__()' or '__pp_op_11__()' not defined"
