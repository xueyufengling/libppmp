#if defined(__pp_op_10__) && defined(__pp_op_13__)
...
#elif (__pp_op_10__()) == (__pp_op_13__())
...
#error "cmp op 10 and op 13 failed. '__pp_op_10__' or '__pp_op_13__' not defined"
