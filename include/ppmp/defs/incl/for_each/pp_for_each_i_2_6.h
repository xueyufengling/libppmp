...
#undef __pp_for_each_i_2_6__
#define __pp_for_each_i_2_6__() 0
#else
#undef __pp_for_each_i_2_6__
...
#undef __pp_for_each_i_2_6__
#define __pp_for_each_i_2_6__() 1
#elif ((__pp_expr_for_each_i__()) / 1000000) % 10 == 2
#undef __pp_for_each_i_2_6__
#define __pp_for_each_i_2_6__() 2
#elif ((__pp_expr_for_each_i__()) / 1000000) % 10 == 3
#undef __pp_for_each_i_2_6__
#define __pp_for_each_i_2_6__() 3
#elif ((__pp_expr_for_each_i__()) / 1000000) % 10 == 4
#undef __pp_for_each_i_2_6__
#define __pp_for_each_i_2_6__() 4
#elif ((__pp_expr_for_each_i__()) / 1000000) % 10 == 5
#undef __pp_for_each_i_2_6__
#define __pp_for_each_i_2_6__() 5
#elif ((__pp_expr_for_each_i__()) / 1000000) % 10 == 6
#undef __pp_for_each_i_2_6__
#define __pp_for_each_i_2_6__() 6
#elif ((__pp_expr_for_each_i__()) / 1000000) % 10 == 7
#undef __pp_for_each_i_2_6__
#define __pp_for_each_i_2_6__() 7
#elif ((__pp_expr_for_each_i__()) / 1000000) % 10 == 8
#undef __pp_for_each_i_2_6__
#define __pp_for_each_i_2_6__() 8
#elif ((__pp_expr_for_each_i__()) / 1000000) % 10 == 9
#undef __pp_for_each_i_2_6__
#define __pp_for_each_i_2_6__() 9
#endif

#else

#error "store digit 6 in 'pp_for_each_i' 2 failed. expr '__pp_expr_for_each_i__()' not defined"
